...
const ProductDetails = async({ params: { id } }: Props) => {
  ...
  return (
    <div className="product-contatiner">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="product-info">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[21px] text-black opacity-50 font-bold line-through">{product.currency} {formatNumber(product.originalPrice)}</p>
            </div>
